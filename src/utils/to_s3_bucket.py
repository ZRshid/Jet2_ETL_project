...
def save_data_to_s3_bucket(raw_data:str, bucket_name:str, file_path:str):
    """
    ...
    if not isinstance(raw_data, str):
        logging.error("There is a type error here")
        raise TypeError("data must be in CSV format")
    else:
