...
def clean_raw_data(df):
    try:
        ...
        index_of_missing_last_names = df[df["last_name"].isna()].index
        input_string= 'unknown'
        for idx in index_of_missing_last_names:
            df.at[idx ,"last_name"] = input_string
        ...
        index_of_currency_is_eur = df.loc[df['currency'] == 'eur'].index
        ...
        df.to_csv('data/cleaned_data.csv', sep=',', index=False, encoding='utf-8')
